...
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_icon`, `sort_num`, `permission`, `path`, `component_name`, `component`, `status`, `affix`, `visible`, `cache`, `embed`, `embed_url`, `dot`, `badge`, `menu_type`, `parent_id`, `show_header`, `show_footer`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`, `always_show`) VALUES (1000, '个人中心', NULL, 10, NULL, '/personal-center', 'PersonalCenter', 'system/personal-center', 0, b'0', b'1', b'1', b'0', NULL, b'1', NULL, 2, 10, b'1', b'1', NULL, '2023-06-05 08:18:37', '1', '2024-04-17 13:01:06', NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_icon`, `sort_num`, `permission`, `path`, `component_name`, `component`, `status`, `affix`, `visible`, `cache`, `embed`, `embed_url`, `dot`, `badge`, `menu_type`, `parent_id`, `show_header`, `show_footer`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`, `always_show`) VALUES (1001, '用户管理', NULL, 20, 'system:user:list', '/users', 'Users', 'system/users', 0, b'0', b'1', b'1', b'0', NULL, b'0', NULL, 2, 10, b'1', b'1', NULL, '2023-06-05 08:18:37', '1', '2024-04-17 13:01:59', NULL, 0, NULL);
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_icon`, `sort_num`, `permission`, `path`, `component_name`, `component`, `status`, `affix`, `visible`, `cache`, `embed`, `embed_url`, `dot`, `badge`, `menu_type`, `parent_id`, `show_header`, `show_footer`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`, `always_show`) VALUES (1008, '任务管理', NULL, 80, 'system:job:list', '/jobs', 'Jobs', 'system/jobs', 0, b'0', b'1', b'1', b'0', NULL, b'0', NULL, 2, 10, b'1', b'1', NULL, '2023-06-05 08:18:37', '1', '2024-04-17 13:02:33', NULL, 0, NULL);
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_icon`, `sort_num`, `permission`, `path`, `component_name`, `component`, `status`, `affix`, `visible`, `cache`, `embed`, `embed_url`, `dot`, `badge`, `menu_type`, `parent_id`, `show_header`, `show_footer`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`, `always_show`) VALUES (1010, '快捷菜单', NULL, 100, NULL, '/usual-menus', 'UsualMenus', 'system/usual-menus', 0, b'0', b'1', b'1', b'0', NULL, b'0', NULL, 2, 10, b'1', b'0', NULL, '2023-06-05 08:18:37', '1', '2024-04-17 13:14:41', NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_icon`, `sort_num`, `permission`, `path`, `component_name`, `component`, `status`, `affix`, `visible`, `cache`, `embed`, `embed_url`, `dot`, `badge`, `menu_type`, `parent_id`, `show_header`, `show_footer`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`, `always_show`) VALUES (2000, '在线用户', NULL, 10, 'monitor:online:list', '/online', 'OnlineUser', 'monitor/online', 0, b'0', b'1', b'0', b'0', NULL, b'0', 'New', 2, 20, b'1', b'1', '1', '2023-06-11 08:20:20', '1', '2024-04-17 13:09:15', NULL, 0, NULL);
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_icon`, `sort_num`, `permission`, `path`, `component_name`, `component`, `status`, `affix`, `visible`, `cache`, `embed`, `embed_url`, `dot`, `badge`, `menu_type`, `parent_id`, `show_header`, `show_footer`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`, `always_show`) VALUES (2100, '代码生成', NULL, 10, 'tools:gen', '/gen', 'Gen', 'tools/generate', 0, b'0', b'1', b'1', b'0', NULL, b'0', NULL, 2, 30, b'1', b'1', NULL, '2023-06-05 08:18:38', '1', '2024-04-17 13:15:48', NULL, 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_icon`, `sort_num`, `permission`, `path`, `component_name`, `component`, `status`, `affix`, `visible`, `cache`, `embed`, `embed_url`, `dot`, `badge`, `menu_type`, `parent_id`, `show_header`, `show_footer`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`, `del_flag`, `always_show`) VALUES (2101, '系统接口', NULL, 20, NULL, '/swagger', NULL, 'tools/swagger', 0, b'0', b'1', b'1', b'1', 'http://localhost:8000/doc.html', b'0', NULL, 2, 30, b'0', b'0', NULL, '2023-06-05 08:18:38', '1', '2024-04-17 13:14:45', NULL, 0, NULL);
...
CREATE TABLE `sys_oper_log` (
  ...
  `req_url` varchar(1024) NOT NULL COMMENT '请求URL',
  ...
  `resp_result` text DEFAULT NULL COMMENT '响应结果',
