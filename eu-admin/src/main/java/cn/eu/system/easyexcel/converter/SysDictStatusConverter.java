 ...
 * @since 2023/7/31
 */
public class SysDictStatusConverter implements Converter<Integer> {
    ...
    public Integer convertToJavaData(ReadCellData<?> cellData, ExcelContentProperty contentProperty, GlobalConfiguration globalConfiguration) throws Exception {
        return SysDictStatus.valueOfDesc(cellData.getStringValue());
    }
    ...
    public WriteCellData<String> convertToExcelData(Integer value, ExcelContentProperty contentProperty, GlobalConfiguration globalConfiguration) throws Exception {
        return new WriteCellData<>(SysDictStatus.parseValue(value));
    }
}
